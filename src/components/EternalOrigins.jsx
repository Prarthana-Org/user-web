    ...
    return (
        <div className="pt-24 pb-16 min-h-screen content-center">
            <style dangerouslySetInnerHTML={{__html: `
                ...
                .trunk .phase { position: relative; margin-bottom: 84px; }
                .trunk .phase::before { content: attr(data-n); position: absolute; left: -50px; top: 2px; width: 36px; height: 36px; border-radius: 50%; background: var(--card-background); border: 1.5px solid var(--gold); color: var(--gold); font-family: ui-monospace, monospace; font-size: .8rem; display: flex; align-items: center; justify-content: center; font-weight: bold; }
                
                @media (max-width: 640px) {
                  .trunk .phase::before { left: -32px; width: 28px; height: 28px; font-size: .65rem; }
                  .trunk .tree details, .trunk .tree .leaf { margin-left: 10px; }
                }
                ...
                .trunk p.lead { max-width: 800px; margin: 14px 0 20px; font-size: 1rem; color: var(--text-secondary); }
                .trunk p.lead strong { color: var(--text-primary); font-weight: 600; }
                
                .trunk .dates { font-family: ui-monospace, monospace; font-size: .7rem; color: var(--text-hint); margin: 10px 0 14px; letter-spacing: .06em; text-transform: uppercase; }
                .trunk .dates b { color: var(--gold); font-weight: 600; }
                ...
                .tree summary .meta { font-family: ui-monospace, monospace; font-size: .63rem; color: var(--text-hint); letter-spacing: .05em; margin-left: auto; text-transform: uppercase; font-weight: bold; }
                ...
                .tree .leaf { margin: 0 0 12px 20px; position: relative; background: var(--card-background); border: 1px solid var(--text-hint); border-radius: 10px; padding: 13px 18px; font-size: .95rem; color: var(--text-secondary); line-height: 1.6; }
                .tree .leaf::before { content: ""; position: absolute; left: -22px; top: 21px; width: 16px; height: 2px; background: var(--text-hint); }
                .tree .leaf b { font-size: 1.05rem; color: var(--text-primary); font-weight: 700; display: inline-block; margin-right: 6px; }
                .tree .leaf i { color: var(--text-secondary); font-style: italic; }
                
                .ref { font-family: ui-monospace, monospace; font-size: .7rem; color: var(--gold); background: rgba(169, 121, 30, 0.1); border: 1px solid rgba(169, 121, 30, 0.2); border-radius: 6px; padding: 2px 8px; white-space: nowrap; margin: 0 4px; font-weight: bold; }
                
                .tier { font-family: ui-monospace, monospace; font-size: .65rem; border-radius: 4px; padding: 2px 8px; letter-spacing: .08em; flex: none; margin-left: 6px; font-weight: bold; }
                .tier.T1 { color: var(--green); border: 1px solid var(--green); background: rgba(46, 125, 83, 0.1); }
                .tier.T2 { color: var(--gold); border: 1px solid var(--gold); background: rgba(169, 121, 30, 0.1); }
                .tier.T3 { color: var(--sindoor); border: 1px solid var(--sindoor); background: rgba(194, 74, 38, 0.1); }
                
                .map { display: block; margin-top: 10px; font-size: .88rem; color: var(--text-secondary); background: var(--background); padding: 8px 12px; border-radius: 6px; border-left: 3px solid var(--sindoor); }
                .map::before { content: "↳ MODERN PARALLEL: "; font-family: ui-monospace, monospace; font-size: .65rem; color: var(--sindoor); letter-spacing: .1em; font-weight: bold; }
                
                .stats { display: flex; gap: 26px; flex-wrap: wrap; margin: 18px 0 26px; }
                .stats div { font-family: ui-monospace, monospace; font-size: .7rem; color: var(--text-hint); letter-spacing: .08em; text-transform: uppercase; }
                .stats div b { display: block; font-size: 1.8rem; color: var(--gold); font-weight: 700; letter-spacing: 0; line-height: 1.2; }
`}} />

            <section className="trunk">
                {/* Existing original intro section */}
                ...
                <div className="tree">
                    <details open>
                        ...
                        <div className="body">
                            <div className="leaf">
                                <b>DEFINITION</b> The ultimate reality (Brahman) manifesting as primordial sound (Nāda). The syllable <strong>Om</strong> represents the entirety of this sonic manifestation.
                                <br/><br/>
                                <b>WHY</b> It establishes that the scriptures are not arbitrary human decrees but expressions of the fundamental harmonics of the universe.
                            </div>
                        </div>
                    </details>
                </div>
                ...
                <div className="tree">
                    <details open>
                        ...
                        <div className="body">
                            <div className="leaf">
                                <b>DEFINITION</b> Sages who "heard" (śruti) the eternal truths. They are referred to as <strong>mantra-draṣṭā</strong> (seers of the mantra).
                            </div>
                        </div>
                    </details>
                </div>
